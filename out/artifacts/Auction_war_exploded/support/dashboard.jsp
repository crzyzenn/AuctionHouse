        ...
        while(rs.next()){
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <%
                            ResultSet sellerInfo = stm.executeQuery("SELECT *  FROM clients WHERE tel = '" + rs.getString(5) +"'");
                                            ...
                                            <table class="formTable" style="color: black; font-weight: 500;">
                                            	<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" name="pNumber" class="form-control" required="required" title="">
                                                                <div class="input-group-addon">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="number" name="sNumber" class="form-control" required="required" title="">
                                                                <div class="input-group-addon">
                                                                    <span class="input-group-text"><span class = "fa fa-phone-square"></span></span>
                                                                </div>
                                                            </div>
